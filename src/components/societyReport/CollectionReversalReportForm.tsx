...
const CollectionReversalReportForm = () => {
  ...
  const validate = (fieldValues: CollectionReportModel = values) => {
    ...
    //   temp.SocietyBuildingId = fieldValues.SocietyBuildingId ? "" : "Field is required.";
    // }
    setErrors({
      ...temp,
    });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      ...
      societyReportService.collectionReversalReportPdf(model).then((response) => {
        let result = response.data;
        let fileName = "CollectionReversalReport.pdf";
...
export default CollectionReversalReportForm
